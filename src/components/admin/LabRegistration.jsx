...
import { FaCalendar, FaEnvelope, FaGlobe, FaIdBadge, FaMale, FaMobile, FaPhone, FaUser } from "react-icons/fa";
import { FaPhoneFlip } from "react-icons/fa6";

const LabRegistration = ({ setIsNewLabRegistrationModalOpen }) => {
      ...
      <div className="p-6 max-w-2xl w-full mx-auto bg-white shadow-2xl bg rounded-lg">
        ...
        <form>
          <div className="grid gap-6 mb-6 md:grid-cols-2">
            <div className="w-full mx-auto">
              ...
              <div className="relative">
                ...
                <input type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-1 focus:ring-green-500 block w-full ps-10 p-2.5 " placeholder="LAB_0013001" required />
              </div>
            </div>
            ...
            <div className="w-full mx-auto">
              ...
              <div className="relative">
                ...
                <input type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-1 focus:ring-green-500 block w-full ps-10 p-2.5 " placeholder="Lab Name" required />
              </div>
            </div>

            {/* <div className="w-full mx-auto">
              <span className="block mb-2 text-sm font-medium text-gray-900">Branch</span>
              <div className="relative">
                <div className="absolute inset-y-0 start-0 top-0 flex items-center ps-3.5 pointer-events-none">
                  <FaUser className="text-gray-500" />
                </div>
            ...
            <div className="w-full mx-auto">
              ...
              <div className="relative">
                ...
                <input type="text" id="mobile" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-1 focus:ring-green-500 block w-full ps-10 p-2.5 " placeholder="your-email@gmail.com" required />
              </div>
            </div> */}
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center w-full sm:w-auto mt-6">
            ...
            <button className="border border-red-500 hover:bg-red-100 hover:cursor-pointer hover:text-red-700 text-red-500 px-4 py-2 font-bold rounded-md text-sm flex items-center justify-center w-48" onClick={() => setIsNewLabRegistrationModalOpen(false)}
            >
              CANCEL
            </button>
          </div>
