...
import { FaBuilding, FaCalendar, FaEnvelope, FaGlobe, FaIdBadge, FaLock, FaMale, FaMobile, FaPhone, FaUser } from "react-icons/fa";
import { FaPhoneFlip } from "react-icons/fa6";
import LabSelection from "./LabSelection";
import { HiBuildingOffice2 } from "react-icons/hi2";
import BranchSelection from "./BranchSelection";

const LabUserRegistration = ({ setIsNewLabUserRegistrationModalOpen }) => {
      ...
      <div className="p-6 max-w-2xl w-full mx-auto bg-white shadow-2xl bg rounded-lg">
        ...
        {/* <form> */}
          ...
          <div className="grid gap-6 mb-6 md:grid-cols-2 border-t pt-3 border-gray-300">
            ...
            <div className="w-full mx-auto">
              ...
              <div className="relative">
                ...
                <input type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-1 focus:ring-green-500 block w-full ps-10 p-2.5 " placeholder="User" required />
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center w-full sm:w-auto mt-6">
            ...
            <button className="border border-red-500 hover:bg-red-100 hover:cursor-pointer hover:text-red-700 text-red-500 px-4 py-2 font-bold rounded-md text-sm flex items-center justify-center w-48" onClick={() => setIsNewLabUserRegistrationModalOpen(false)}
            >
              CANCEL
            </button>
          </div>
...
export default LabUserRegistration;
