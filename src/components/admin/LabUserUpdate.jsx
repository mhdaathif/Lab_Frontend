...
import { FaCalendar, FaGlobe, FaIdBadge, FaMale, FaMobile, FaPhone, FaUser } from "react-icons/fa";
import { FaPhoneFlip } from "react-icons/fa6";
import LabSelection from "./LabSelection";
import { IoShieldCheckmark } from "react-icons/io5";

const LabUserUpdate = ({ setIsUpdateLabUserModalOpen }) => {
          ...
          <div className="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div className="w-full mx-auto">
              ...
              <div className="relative">
                ...
                <input type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-1 focus:ring-green-500 block w-full ps-10 p-2.5 " placeholder="UserRole" required />
              </div>
            </div>
            ...
            <div className="w-full mx-auto">
              ...
              <div className="relative">
                ...
                <input type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-1 focus:ring-green-500 block w-full ps-10 p-2.5 " placeholder="2000-01-01" required />
              </div>
            </div>
