...
import {FaCalendar, FaIdBadge, FaUser} from "react-icons/fa";
import {HiPhone} from "react-icons/hi2";
import {TbStatusChange} from "react-icons/tb";
import {BiSort} from "react-icons/bi";
import DeleteConfirmation from "../layout/DeleteConfirmation.jsx";
import {PaymentRegistration} from "./PaymentRegistration.jsx";
import {PaymentUpdate} from "./PaymentUpdate.jsx";
...
export const ManagePayment = () => {
    const initialData = [
        {
            ...
            branchId: "BR-001",
            branch: "Mawanella",
            branchMobile: "0777514445",
            subscription: "Monthly",
            registerDate: "2025-02-20",
            status: "Paid",
            amount: "25000.00",
            lastRenewal: "2025-02-20",
            expiry: "2025-03-20",
        },
        {
            id: "1",
            ...
            branchId: "BR-002",
            branch: "Kegalla",
            branchMobile: "0712345678",
            subscription: "Monthly",
            registerDate: "2025-03-13",
            status: "Paid",
            amount: "25000.00",
            lastRenewal: "2025-03-20",
            expiry: "2025-04-20",
        },
    ];
    ...
    return (
        <div className="bg-gray-50 min-h-screen p-6">
            <h1 className="text-xl font-medium text-gray-700 mb-6">Manage Payments</h1>
                ...
                <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                        <button
                            ...
                            <span className="mr-1">+</span> ADD NEW PAYMENT
                        </button>
                        <button
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                        <div className="w-full sm:w-54 flex gap-x-2 justify-center mt-auto">
                            <div className="w-1/2">
                                <button
                                    className="border w-full border-gray-300 px-3 py-2 rounded-md text-gray-500 flex items-center justify-center hover:bg-gray-200 hover:cursor-pointer"
                ...
                {showFilters && (
                    <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4">
                        <div className="flex flex-wrap gap-4 w-full sm:w-auto mt-5">
                            ...
                            <div className="w-full sm:w-64">
                                <span
                                    className="block mb-2 text-sm font-medium text-gray-900">Search by Branch Name</span>
                                <div className="relative">
                                    <div
                                        className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                        <FaUser className="text-gray-500"/>
                            ...
                            <div className="w-full sm:w-64">
                                <span
                                    className="block mb-2 text-sm font-medium text-gray-900">Search by Branch Mobile</span>
                                <div className="relative">
                                    <div
                                        className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
        ...
        <div className="text-center">
          ...
          <div className="text-xl font-semibold">{summaryData.totalOrderValue}</div>
                ...
                <table className="min-w-full rounded-xl p-4 bg-green-300/20">
                    ...
                    {payments.map((payment) => (
                        <tr key={payment.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-4 py-3 border border-gray-200 whitespace-nowrap text-sm text-gray-500">
                                <div>
                                    <p><strong>{payment.labId}</strong></p>
                                    <p className="text-xs text-gray-500">{payment.labName}</p>
                                </div>
                            </td>
                            <td className="px-4 py-3 border border-gray-200 whitespace-nowrap text-sm text-gray-500">
                                <div>
                                    <p><strong>{payment.branchId}</strong></p>
                                    <p className="text-xs text-gray-500">{payment.branch}</p>
                                </div>
                            </td>
                            <td className="px-4 py-3 border border-gray-200 whitespace-nowrap text-sm text-gray-500">
                                {payment.branchMobile}
                            </td>
                            <td className="px-4 py-3 border border-gray-200 whitespace-nowrap text-sm text-gray-500">
                                <span
            ...
            {isAddPaymentModalOpen && (
                <PaymentRegistration setIsAddPaymentModalOpen={setIsAddPaymentModalOpen}/>
            )}

            {isUpdatePaymentModalOpen && (
                <PaymentUpdate setIsUpdatePaymentModalOpen={setIsUpdatePaymentModalOpen}/>
            )}
