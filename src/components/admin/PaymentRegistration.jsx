import {FaBuilding, FaCalendar, FaEnvelope, FaGlobe, FaIdBadge, FaLock, FaMale, FaPhone, FaUser} from "react-icons/fa";
...
export const PaymentRegistration = ({setIsAddPaymentModalOpen}) => {
