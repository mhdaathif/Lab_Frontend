...
import LabUserUpdate from './LabUsersUpdate';
...
const BranchesUsersList = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen p-6">
      <h1 className="text-xl font-medium text-gray-700 mb-6">Manage Branches Users</h1>
...
export default BranchesUsersList;