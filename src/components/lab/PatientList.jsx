...
const PatientList = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen p-6">
      <h1 className="text-xl font-medium text-gray-700 mb-6">Patient List</h1>
            ...
            <div className="flex flex-wrap gap-4 w-full sm:w-auto mt-5">
              <div className="w-full sm:w-64">
                ...
                <div className="relative">
                  ...
                  <input type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-1 focus:ring-green-500 block w-full pl-10 p-2.5" placeholder="PAT_00001" />
                </div>
              </div>
      ...
      {isUpdatePatientModalOpen && (
        <PatientUpdate setIsUpdatePatientModalOpen={setIsUpdatePatientModalOpen} />
      )}
