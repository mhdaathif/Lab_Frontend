...
const PatientRegistration = ({ setIsAddPatientModalOpen }) => {
      ...
      <div className="p-6 max-w-2xl w-full mx-auto bg-white shadow-2xl bg rounded-lg">
        ...
        <form>
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center w-full sm:w-auto mt-6">
            ...
            <button className="border border-red-500 hover:bg-red-100 hover:cursor-pointer hover:text-red-700 text-red-500 px-4 py-2 font-bold rounded-md text-sm flex items-center justify-center w-48" onClick={() => setIsAddPatientModalOpen(false)}
            >
              CANCEL
            </button>
          </div>
