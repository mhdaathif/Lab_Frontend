...
const TestTypeUpdate = ({ setIsUpdateTestTypeModalOpen }) => {
        ...
        <form>
          <div className="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div className="w-full mx-auto">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 start-0 top-0 flex items-center ps-3.5 pointer-events-none">
                  <CgArrowsExchange className="text-gray-500" />
                </div>
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center w-full sm:w-auto mt-6">
            ...
            <button className="border border-red-500 hover:bg-red-100 hover:cursor-pointer hover:text-red-700 text-red-500 px-4 py-2 font-bold rounded-md text-sm flex items-center justify-center w-48" onClick={() => setIsUpdateTestTypeModalOpen(false)}
            >
              CANCEL
            </button>
          </div>
